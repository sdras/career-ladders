<template>
  <div>
    ...
    <p>
      <strong
        ><a
          ...
          target="_blank"
          >This writeup explains a bit more about my process ></a
        ></strong
      >
    </p>
    <p>
    ...
    <p>
      I'm open sourcing my career ladders so people have a launching-off point.
      I do not have this all figured out, please feel free to iterate, or give
      feedback, or submit a PR. Full transparency, I don't have a ton of time
      for maintenance right now, and am maintaining a
      <span class="italic">lot</span> of repos, so if your PR goes unnoticed for
      a while, that's why. I also may reject a PR if it's not the way I
      personally want to structure something, but that's ok! It's alright for us
      to have different ways of creating laddering.
    </p>
    <p>
      In fact, I would encourage one to make some changes depending on your org
      in particular, we don't have to all be the same, and probably shouldn't
      be.
    </p>
    <p>
